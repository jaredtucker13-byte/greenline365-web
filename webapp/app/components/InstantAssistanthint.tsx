export function InstantAssistantHint() {
  return (
    <div className="fixed bottom-28 right-6 max-w-xs rounded-2xl border border-gold-500/40 bg-black/60 px-4 py-3 text-left text-sm shadow-lg backdrop-blur z-30">
      <div className="mb-2 text-[11px] font-semibold tracking-wide text-gold-300">
        INSTANT ASSISTANT
      </div>

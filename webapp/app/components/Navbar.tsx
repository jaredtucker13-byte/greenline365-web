          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="font-heading">
                ...
                <div className="text-[10px] text-white/30 tracking-[0.2em] uppercase font-medium -mt-0.5">Florida&apos;s Local Guide</div>
              </div>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <Link
                href="/#categories"
                className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:border-gold/40 hover:bg-gold/5 transition-all duration-300 ml-2"
                title="Search Directory"
              >
                <svg className="w-4 h-4 text-white/60 hover:text-gold transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {loading ? (
                <div className="flex items-center gap-3 ml-2">
                  <Link
                    ...
                    className="text-xs text-white/40 hover:text-gold transition-colors duration-300"
                  >
                    Add Your Business
                  </Link>
                  <Link
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            >
              <div className="w-full max-w-sm space-y-3 mt-20">
                {navLinks.map((link, index) => (
                  <motion.div
                    key={link.href || link.label}
                    ...
                    {user ? (
                      ...
                      <>
                        ...
                        <Link
                          href="/register-business"
                          onClick={() => setMobileMenuOpen(false)}
                          className="block w-full text-center text-sm text-white/40 hover:text-gold py-2 transition-all duration-300"
                        >
                          Add Your Business
                        </Link>
                      </>

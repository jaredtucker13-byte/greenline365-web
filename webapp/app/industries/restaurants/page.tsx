      ...
      <main className="min-h-screen bg-os-dark relative">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="mb-4 inline-flex items-center gap-2 px-3 py-1.5 glass-gold rounded-full border border-gold-500/30">
                  ...
                  <span className="text-xs text-gold-400 font-semibold tracking-wide">FOR RESTAURANTS</span>
                </div>
                
                <h1 className="font-display font-bold text-white mb-6" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: '1.1' }}>
                  Fill Every Table with <span className="text-gold-500">AI Automation</span>
                </h1>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 bg-gold-500/10 rounded-lg border border-gold-500/30">
                        <div className="text-gold-400 text-xs mb-1">✓ New Reservation</div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                How <span className="text-gold-500">GreenLine365</span> Solves This
              </h2>
            </div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Real Restaurant <span className="text-gold-500">Success Stories</span>
              </h2>
            </div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Built for <span className="text-gold-500">Restaurant Operations</span>
              </h2>
            </div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Restaurant <span className="text-gold-500">FAQs</span>
              </h2>
            </div>
          ...
          <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
            <div className="os-card p-12 text-center">
              <h2 className="font-display font-bold text-white mb-4 text-3xl">
                Fill Every Table. <span className="text-gold-500">Automatically.</span>
              </h2>

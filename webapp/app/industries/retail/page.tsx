      ...
      <main className="min-h-screen bg-os-dark relative">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="mb-4 inline-flex items-center gap-2 px-3 py-1.5 glass-gold rounded-full border border-gold-500/30">
                  ...
                  <span className="text-xs text-gold-400 font-semibold tracking-wide">FOR RETAIL STORES</span>
                </div>
                
                <h1 className="font-display font-bold text-white mb-6" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: '1.1' }}>
                  Drive <span className="text-gold-500">Foot Traffic</span> with AI
                </h1>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 bg-gold-500/10 rounded-lg border border-gold-500/30">
                        <div className="text-gold-400 text-xs mb-1">🔥 Trending Now</div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Turn Local Trends into <span className="text-gold-500">Store Traffic</span>
              </h2>
            </div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Real Retail <span className="text-gold-500">Results</span>
              </h2>
            </div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Built for <span className="text-gold-500">Retail Success</span>
              </h2>
            </div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Retail <span className="text-gold-500">Questions</span>
              </h2>
            </div>
          ...
          <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
            <div className="os-card p-12 text-center">
              <h2 className="font-display font-bold text-white mb-4 text-3xl">
                Compete with Amazon. <span className="text-gold-500">Win Locally.</span>
              </h2>

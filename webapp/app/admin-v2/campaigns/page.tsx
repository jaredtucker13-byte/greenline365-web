        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/admin-v2/campaigns/compose" className="px-4 py-2 rounded-lg border border-[#C9A84C]/50 text-[#C9A84C] font-semibold hover:bg-[#C9A84C]/10 transition flex items-center gap-2" data-testid="compose-email-btn">

...
const navItems = [
  ...
  // --- Booking Suite ---
  { id: 'divider-booking', label: 'BOOKING SUITE', icon: '', href: '', feature: null, isDivider: true },
  { id: 'booking-suite', label: 'Booking Suite', icon: 'zap', href: '/admin-v2/booking-suite', feature: 'bookings' },
  // --- System ---

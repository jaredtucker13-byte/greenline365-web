              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h3 className="text-base font-heading font-semibold text-white tracking-tight">
                    Similar Businesses{listing.city ? ` in ${listing.city}` : ''}
                  </h3>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {listing.related.slice(0, 4).map((r) => (
                    <Link
                      key={r.id}
                      href={`/listing/${r.slug}`}
                      className="rounded-xl border border-white/5 overflow-hidden hover:border-[rgba(201,168,76,0.25)] hover:scale-[1.02] transition-all duration-300 ease-out group"

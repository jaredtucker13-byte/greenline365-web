...
export const metadata: Metadata = {
    ...
    description:
          'AI-powered business automation platform that connects local businesses with their community. Automated scheduling, AI content creation, and 24/7 smart booking. Built for real-world results.',
    keywords: [
          // Core AEO Keywords
    ...
    openGraph: {
          ...
          description:
                  'AI-powered business automation that connects local businesses with their community. Automated scheduling, content creation, and smart booking built for real-world results.',
          images: [
            {
    ...
    twitter: {
          ...
          description:
                  'AI automation platform connecting local businesses with their community. Automated scheduling, content creation, and smart booking.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    return (
          <html lang="en">
                        ...
                        <script
                                    ...
                                    dangerouslySetInnerHTML={{
                                                  __html: JSON.stringify({
                                                                  ...
                                                                  description:
                                                                                    'Local business directory connecting consumers with verified businesses across Florida. Find dining, services, nightlife, wellness, and more.',
                                                                  foundingDate: '2024',
                                                                  contactPoint: {
                                                                                    '@type': 'ContactPoint',
                        ...
                        <script
                                    ...
                                    dangerouslySetInnerHTML={{
                                                  __html: JSON.stringify({
                                                                  ...
                                                                  description:
                                                                                    'Local business directory for Florida. Browse verified businesses across dining, services, nightlife, health & wellness, and more.',
                                                                  featureList: [
                        ...
                        <script
                                    ...
                                    dangerouslySetInnerHTML={{
                                                  __html: JSON.stringify({
                                                                  ...
                                                                  description:
                                                                                    'Local business directory serving businesses and consumers across Florida.',
                                                                  areaServed: {
                                                                                    '@type': 'Country',
                                                                                    name: 'United States',
                                                                  },
                ...
                <body className={`min-h-screen bg-obsidian ${playfair.variable} ${manrope.variable} ${inter.variable}`}>

...
async function sendListingLiveEmail(to: string, businessName: string, slug: string) {
  ...
  await fetch('https://api.sendgrid.com/v3/mail/send', {
    ...
    body: JSON.stringify({
      ...
      from: { email: process.env.SENDER_EMAIL || 'noreply@greenline365.com', name: 'GL365 Directory' },
      reply_to: { email: process.env.REPLY_EMAIL || 'reply@reply.greenline365.com', name: 'GL365 Directory' },
      content: [{
        type: 'text/html',

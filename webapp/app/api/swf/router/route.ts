...
const MODEL_MAP: Record<string, string> = { "opus_4.6": "anthropic/claude-opus-4", gpt_4o: "openai/gpt-4o", haiku: "anthropic/claude-3.5-haiku", perplexity: "perplexity/sonar-pro" };

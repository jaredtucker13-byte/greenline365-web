...
import { getSkillContextForIntent, getSkillContext } from '@/lib/marketing-skills-loader';
  ...
  const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: 'system',
          content: `You are a world-class content strategist from 15 years in the future. You write content that converts readers into customers. Your writing is clear, punchy, and valuable. You avoid fluff, jargon, and generic advice. Every sentence earns its place.${getSkillContextForIntent(prompt)}`
        },

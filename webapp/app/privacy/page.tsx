            ...
            {customContent ? (
              ...
              <>
                ...
                <section id="directory-data" className="scroll-mt-24">
                  ...
                  <p className="text-white/70 leading-relaxed mb-5">
                    GreenLine365 operates a local business directory. Business data is collected and displayed as follows:
                  </p>
                  <div className="space-y-4">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-5">
                      <h3 className="font-semibold text-white mb-2">Publicly Available Business Information</h3>
                      <p className="text-white/60 text-sm">
                        Business listings are populated using publicly available data from Google Places API, including business name, address, phone number, website, photos, ratings, and review counts. This information is already publicly accessible through Google Maps and similar services.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-5">
                      <h3 className="font-semibold text-white mb-2">Claimed Listing Data</h3>
                      <p className="text-white/60 text-sm">
                        When a business owner claims their listing, we collect their account credentials (email, password) and any additional business information they choose to provide, such as updated descriptions, photos, or contact details.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-5">
                ...
                <section id="reviews-ai" className="scroll-mt-24">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-5">
                      <h3 className="font-semibold text-white mb-2">GL365 Reviews</h3>
                      <p className="text-white/60 text-sm">
                        When you submit a review, we collect your display name, star rating, review text, and the date of submission. Reviews are publicly visible on the business listing page. We do not collect your email or contact information when submitting a review.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-5">
                      <h3 className="font-semibold text-white mb-2">AI-Generated Responses</h3>
                      <p className="text-white/60 text-sm">
                        Business owners may use AI-assisted tools to draft responses to reviews. These AI drafts are generated by third-party AI providers (such as OpenAI via OpenRouter). Your review text is sent to these providers solely for the purpose of generating a contextual response. AI responses are always subject to business owner approval unless the owner has explicitly enabled automatic responses.
                      </p>
                    </div>
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-5">
                      <h3 className="font-semibold text-amber-400 mb-2">Review Content Policy</h3>
                      <p className="text-white/60 text-sm">
                        Reviews must be based on genuine experiences and contain at least 10 characters of descriptive text. We reserve the right to remove reviews that are fraudulent, abusive, or violate our Terms of Service. Reviews are not verified for accuracy and represent the opinion of the reviewer only.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section id="analytics-tracking" className="scroll-mt-24">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-5">
                      <h3 className="font-semibold text-white mb-2">Listing Analytics</h3>
                      <p className="text-white/60 text-sm">
                        We track anonymous interaction events on business listing pages, including page views, phone call button clicks, website clicks, and directions requests. This data is aggregated and provided to business owners as analytics. No personally identifiable information is associated with these events.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-5">
                      <h3 className="font-semibold text-white mb-2">Transaction Fees</h3>
                      <p className="text-white/60 text-sm">
                        Certain high-value interactions (such as phone calls initiated through the &ldquo;Call Now&rdquo; button) may incur a per-interaction fee charged to the business owner. These fees are disclosed in the business owner&rsquo;s dashboard and Terms of Service. Consumers are never charged for interacting with listings.
                      </p>
                    </div>
                  </div>
                </section>

  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-yellow-400/80 text-sm font-medium">Audit &amp; Distribution</span>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          {summary && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <motion.div
                ...
                className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-6"
              >
                <div className="text-3xl font-bold text-yellow-400">{summary.byStatus?.success || 0}</div>
          ...
          <motion.div
            ...
            className="p-6 rounded-2xl bg-gradient-to-r from-yellow-400/10 to-amber-600/10 border border-yellow-400/20"
          >

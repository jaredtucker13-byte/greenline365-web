...
const EVENT_TYPES = [
  ...
  { color: 'bg-gold-500', label: 'Content', count: 5 },
      ...
      <main className="min-h-screen bg-os-dark relative">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="mb-4 inline-flex items-center gap-2 px-3 py-1.5 glass-gold rounded-full border border-gold-500/30">
                  ...
                  <span className="text-xs text-gold-400 font-semibold tracking-wide">UNIFIED CALENDAR</span>
                </div>

                <h1 className="font-display font-bold text-white mb-6" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: '1.1' }}>
                  One Calendar for <span className="text-gold-500">Everything</span>
                </h1>
                ...
                <div className="os-card p-6">
                  <div className="flex items-center justify-between pb-4 border-b border-white/10 mb-4">
                    ...
                    <div className="flex gap-1">
                      <button className="px-3 py-1 text-xs bg-gold-500/20 text-gold-400 rounded-md border border-gold-500/30">Month</button>
                      ...
                      return (
                        <div
                          ...
                          className={`py-1.5 rounded-md text-xs relative ${
                            isToday ? 'bg-gold-500/20 text-gold-400 font-bold border border-gold-500/40' : 'text-white/60'
                          }`}
                        >
                          {day}
                          <div className="flex gap-0.5 justify-center mt-0.5">
                            {hasBlue && <span className="w-1 h-1 rounded-full bg-blue-500" />}
                            {hasGreen && <span className="w-1 h-1 rounded-full bg-gold-500" />}
          ...
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Every Event, <span className="text-gold-500">One View</span>
              </h2>
            ...
            <div className="grid md:grid-cols-5 gap-4">
              {[
                ...
                { icon: '📝', color: 'border-gold-500/40 bg-gold-500/10', title: 'Content', desc: 'Scheduled posts and articles' },
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                Built for <span className="text-gold-500">Marketing Teams</span>
              </h2>
            </div>
        ...
        <section className="py-20 relative">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-white mb-3 text-4xl">
                How Does <span className="text-gold-500">Calendar Integration</span> Work?
              </h2>
            </div>
          ...
          <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
            <div className="os-card p-12 text-center">
              <h2 className="font-display font-bold text-white mb-4 text-3xl">
                Stop Juggling <span className="text-gold-500">Five Different Calendars</span>
              </h2>

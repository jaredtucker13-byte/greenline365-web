...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'radial-gold': 'radial-gradient(circle, rgba(201, 168, 76, 0.15) 0%, transparent 70%)',
        'radial-gold-soft': 'radial-gradient(circle, rgba(201, 168, 76, 0.08) 0%, transparent 70%)',
        'gold-gradient': 'linear-gradient(135deg, #C9A84C 0%, #E8C97A 50%, #C9A84C 100%)',
        'gold-gradient-reverse': 'linear-gradient(135deg, #E8C97A 0%, #C9A84C 100%)',
        'obsidian-gradient': 'linear-gradient(180deg, #0A0A0A 0%, #111111 100%)',
        'depth-gradient': 'linear-gradient(180deg, #000000 0%, #0A0A0A 30%, #111111 60%, #0A0A0A 100%)',
      },
      boxShadow: {
        'gold-sm': '0 0 12px rgba(201, 168, 76, 0.15), 0 0 4px rgba(201, 168, 76, 0.1)',
        'gold-md': '0 0 20px rgba(201, 168, 76, 0.25), 0 0 40px rgba(201, 168, 76, 0.12)',
        'gold-lg': '0 0 30px rgba(201, 168, 76, 0.35), 0 0 60px rgba(201, 168, 76, 0.15)',
        'gold-glow': '0 0 20px rgba(201, 168, 76, 0.25), 0 0 60px rgba(201, 168, 76, 0.1)',
        'glass': '0 8px 32px 0 rgba(0, 0, 0, 0.5)',
        'glass-sm': '0 4px 16px 0 rgba(0, 0, 0, 0.35)',
        'depth': '0 24px 64px -12px rgba(0, 0, 0, 0.8)',
        'depth-sm': '0 10px 40px -10px rgba(0, 0, 0, 0.6)',
        'inner-highlight': 'inset 0 1px 0 rgba(255, 255, 255, 0.08)',
        'intel-glow': '0 0 24px rgba(201, 168, 76, 0.35), 0 0 64px rgba(201, 168, 76, 0.15)',
        // Legacy aliases
        'neon-green': '0 0 20px rgba(201, 168, 76, 0.3), 0 0 40px rgba(201, 168, 76, 0.15)',
        'neon-teal': '0 0 20px rgba(201, 168, 76, 0.25), 0 0 40px rgba(201, 168, 76, 0.12)',

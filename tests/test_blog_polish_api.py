...
def test_create_blog_post_without_style(api_client, sample_blog_content):
...
def test_create_blog_post_with_style_guide(api_client, sample_blog_content, sample_style_guide):
...
def test_create_blog_post_validation(api_client):
...
def test_get_blog_posts(api_client):
...
def test_style_analysis_api(api_client, sample_blog_content):
...
def test_style_analysis_validation(api_client):
...
def test_seo_analysis_api(api_client, sample_blog_content):
...
def test_image_analysis_api(api_client, sample_blog_content):
...
def test_verify_style_guide_in_database(supabase_client, api_client, sample_blog_content, sample_style_guide):
...
# ==================== Invalid Actions Tests ====================

def test_invalid_action(api_client):

...
|-------|-------------|--------|
| 0 | Foundation (legal pages, DB integration) | ✅ Complete |
| 1 | Design System (GSAP, Glassmorphism, tokens) | ✅ Complete |
| **2A** | **Directory Homepage** (hero, search, category cards) | 🔵 Next |
| **2B** | **Home Ledger Landing Page** (/home-ledger — obsidian vault aesthetic) | 🔵 Next |
| 3 | /pricing page (3 tiers ONLY — $0/$45/$89) | 🔵 Planned |
| 4 | Navigation & Global UI | 🔵 Planned |
| 5 | Command Center polish + Live Local Pulse | 🔵 Planned |
| 6 | Advanced Animations (GSAP ScrollTrigger, phone draw) | 🔵 Planned |
| 7 | CTA Bands, Footer, Polish & Accessibility | 🔵 Planned |
